...
//        Log.i(TAG, "---httpPost----json = " + json);
    ...
    public void httpPost1() {   //登录请求
        ...
        params.put("userAccount", userAccount.getText().toString());
        params.put("password", password1.getText().toString());

        JsonObjectRequest request = new JsonObjectRequest(
                com.android.volley.Request.Method.POST, "http://112.74.165.209:3020/login",
                ...
                new com.android.volley.Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject jsonobj) {
                        ...
                        try {
                            ...
                            com.example.wangyinews.wangyinews.Bean.UserBean userBean = new UserBean(username, userLevel);
                            CoreApplication.getInstance().setUserBean(userBean);
                            if (Flag == 1) {
...
//                .build();
//
//        Log.i(TAG, "---httpPost----request.body().contentType() = " + request.body().contentType());
//
//        OkHttpClient okHttpClient = new OkHttpClient();
//        okHttpClient.newCall(request).enqueue(new Callback() {
//            @Override
